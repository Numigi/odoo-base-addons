...
class ResConfigSettings(models.TransientModel):
    ...
    def _should_disable_column_protection(self):
        return (
            self.database_bi_user_disable_column_protection
            and not self._is_bi_column_protection_disabled()
        )

    def _should_enable_column_protection(self):
        return (
            not self.database_bi_user_disable_column_protection
            and self._is_bi_column_protection_disabled()
        )
